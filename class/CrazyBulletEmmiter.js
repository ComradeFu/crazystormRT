...
module.exports = class CrazeBulletEmmiter extends CrazyObject
{
    ...
    init_event_group()
    {
        ...
        if(emmiter_events)
            this.event_group.init_by_conf(emmiter_events)
    }
    ...
    emmit_bullets()
    {
        ...
        for(let index = 0; index < bullet_count; index ++)
        {
            ...
            emmit_angle = emmit_angle + random(0, this.conf.speed_angle_rand + 1)
    ...
    on_update()
    {
        ...
        //递增
        this.next_emmit_time = this.conf.interval + random(0, this.conf.interval_rand + 1)
